...
function WhatsAppButton() {
  ...
  const waLink = `https://wa.me/${profile.phone.replace(/[^0-9]/g, '')}?text=Hi%20Ganesh%2C%20I%20saw%20your%20portfolio!`;
  return (
    <AnimatePresence>
      {show && (
        <motion.a
          ...
          whileTap={{ scale: 0.95 }}
          className="fixed bottom-6 right-6 z-50 w-14 h-14 rounded-full bg-[#25D366] shadow-[0_4px_20px_rgba(37,211,102,0.4)] flex items-center justify-center text-white hover:shadow-[0_4px_30px_rgba(37,211,102,0.6)] transition-shadow"
        >
          {/* Ping ring */}
